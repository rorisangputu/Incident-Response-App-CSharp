    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TaskVolunteerId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskVolunteers", x => x.TaskVolunteerId);
                    table.ForeignKey(
                        name: "FK_TaskVolunteers_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TaskVolunteers_Tasks_ProjectTaskId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskVolunteers_AppUserId",
                table: "TaskVolunteers",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_TaskVolunteers_ProjectTaskId",
                table: "TaskVolunteers",
